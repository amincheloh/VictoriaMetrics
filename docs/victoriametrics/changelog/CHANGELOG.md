...
* BUGFIX: [vmsingle](https://docs.victoriametrics.com/single-server-victoriametrics/): consistently create all config reload related metrics only if config is present. See [this issue](https://github.com/VictoriaMetrics/helm-charts/issues/2119) for details.
